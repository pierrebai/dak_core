   ...
   namespace
   {
      struct compare_op_init_t
      {
         compare_op_init_t()
         {
            ...
            make_binary_op<comparison_t,  text_t,    text_t,   compare_op_t>([](const text_t& arg_a, const text_t& arg_b) -> comparison_t { if (arg_a < arg_b) return comparison_t::less; if (arg_a > arg_b) return comparison_t::more; return comparison_t::equal; });
            make_binary_op<comparison_t,  array_t,   array_t,  compare_op_t>([](const array_t& arg_a, const array_t& arg_b) -> comparison_t { if (arg_a < arg_b) return comparison_t::less; if (arg_a > arg_b) return comparison_t::more; return comparison_t::equal; });
            make_binary_op<comparison_t,  dict_t,    dict_t,   compare_op_t>([](const dict_t& arg_a, const dict_t& arg_b) -> comparison_t { if (arg_a < arg_b) return comparison_t::less; if (arg_a > arg_b) return comparison_t::more; return comparison_t::equal; });
            ...
            make_binary_op<comparison_t,  str_ptr_t, text_t,   compare_op_t>([](str_ptr_t arg_a, const text_t& arg_b) -> comparison_t { const text_t t_a(arg_a ? arg_a : L""); if (t_a < arg_b) return comparison_t::less; if (t_a > arg_b) return comparison_t::more; return comparison_t::equal; });
            make_binary_op<comparison_t,  text_t,    str_ptr_t,compare_op_t>([](const text_t& arg_a, str_ptr_t arg_b) -> comparison_t { const text_t t_b(arg_b ? arg_b : L""); if (arg_a < t_b) return comparison_t::less; if (arg_a > t_b) return comparison_t::more; return comparison_t::equal; });
         }
      };
