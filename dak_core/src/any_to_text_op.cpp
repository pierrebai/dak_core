   ...
   namespace
   {
      struct to_text_op_init_t
      {
         to_text_op_init_t()
         {
            ...
            unary_op_t<to_text_op_t>::make_op<text_t, name_t   >([](name_t arg_a          ) -> text_t { return arg_a.as_text(); });
            ...
            unary_op_t<to_text_op_t>::make_op<text_t, array_t  >([](const array_t& arg_a  ) -> text_t { std::wostringstream os; os << arg_a; return os.str(); });
            unary_op_t<to_text_op_t>::make_op<text_t, dict_t   >([](const dict_t& arg_a   ) -> text_t { std::wostringstream os; os << arg_a; return os.str(); });
