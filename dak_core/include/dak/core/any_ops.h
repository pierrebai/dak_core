...
namespace dak_ns::core_ns
{
   ...
   struct is_compatible_op_t : binary_op_t<is_compatible_op_t>
   {
      ...
      {
         std::any result = binary_ops_t<is_compatible_op_t>::call(std::make_any<A>(), arg_b);
         if (result.has_value())
      ...
      static bool call()
      {
         std::any result = binary_ops_t<is_compatible_op_t>::call(std::make_any<A>(), std::make_any<B>());
         if (result.has_value())
            return std::any_cast<bool>(result);
         else
            return false;
   ...
   //////////////////////////////////////////////////////////////////////////
   //
   // The dominant operation converts the first argument to the dominant
   // type between the two. The dominant type is the type in which the
