   ...
   TEST_CLASS(compare_op_tests)
	...
	public:
      ...
      TEST_METHOD(element_constructors)
      {
         ...
         Assert::AreEqual(typeid(array_t), e_a.type());
         Assert::AreEqual(typeid(dict_t), e_d.type());
         Assert::AreEqual(typeid(name_t), e_n.type());
      }
      ...
      TEST_METHOD(element_conversion)
      {
         ...
         Assert::AreEqual<std::any>((array_t()), e_a);
         Assert::AreEqual<std::any>((dict_t()), e_d);
         Assert::AreEqual<std::any>(ns::view, e_n);
      }
      ...
      TEST_METHOD(element_const_conversion)
      {
         ...
         const std::any e_a((array_t()));
         const std::any e_d((dict_t()));
         const std::any e_n(ns::view);
      ...
      TEST_METHOD(element_unknown_assignments)
      {
         ...
         Assert::AreEqual(typeid(void), e_a.type());
         Assert::AreEqual(typeid(void), e_d.type());
         Assert::AreEqual(typeid(void), e_n.type());
      }
