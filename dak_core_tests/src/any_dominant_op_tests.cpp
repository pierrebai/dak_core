...
namespace tests
{		
   TEST_CLASS(any_dominant_op_tests)
	{
	public:
      TEST_METHOD(dominant)
      {
         ...
         Assert::AreEqual<std::any>(ns::above, dominant_op_t::call<bool, name_t>(ns::above));
         Assert::AreEqual<std::any>(a1, dominant_op_t::call<bool, array_t>(a1));
         Assert::AreEqual<std::any>(d1, dominant_op_t::call<bool, dict_t>(d1));
